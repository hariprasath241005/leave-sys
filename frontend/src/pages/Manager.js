...
function Manager() {
  ...
  const save = async () => {
    await fetch("http://localhost:5000/api/config", {
      ...
      body: JSON.stringify({ managerLimit: limit })
    });
    ...
    <div className="container">
      ...
      <div className="glass-panel" style={{marginTop: '20px'}}>
        ...
        <div className="step-card">
          ...
          <p style={{marginBottom: '1rem'}}>Modify the boundaries for the Workflow Engine below. Executions matching this requirement (`leave_days &lt;= config.managerLimit`) will instantly route past your desk recursively.</p>
